...
namespace Business.AccessHelper
{
	/// <summary>
	...
	{
		private static String connectionString = "Provider=Microsoft.ACE.OLEDB.12.0;Data Source=" + ConfigurationSettings.AppSettings["Default"]; 
