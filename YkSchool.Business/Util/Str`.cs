...
namespace Util {
    ...
    public sealed partial class Str {
        ...
        public static string Filter(string sInput)
        {
            ...
            if (System.Text.RegularExpressions.Regex.Match(sInput1, System.Text.RegularExpressions.Regex.Escape(pattern), RegexOptions.Compiled | RegexOptions.IgnoreCase).Success)
            {
